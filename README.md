...
O **PetTosa** é um aplicativo mobile criado com **React Native** e **NativeWind**, idealizado para facilitar o agendamento de serviços em petshops. Com ele, tutores de pets conseguem marcar banho, tosa, vacinação e outros serviços com rapidez, praticidade e conforto — direto do celular!
